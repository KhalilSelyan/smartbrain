...
class App extends Component {
  ...
  onPictureSubmit = () => {
    ...
    fetch("https://peaceful-brook-75721.herokuapp.com/imageurl", {
      method: "post",
      ...
      .then((response) => {
        if (response) {
          fetch("https://peaceful-brook-75721.herokuapp.com/image", {
            method: "put",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
            ...
            .then((count) => {
              this.setState(
                Object.assign(this.state.user, { detections: count })
              );
            })
            .catch(console.log);
        }
        ...
        {route === "home" ? (
          <div>
            ...
            <Rank
              ...
              detections={this.state.user.detections}
            />
            <ImageLinkForm
